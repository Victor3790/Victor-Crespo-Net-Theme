			...
			<div class="row hero__row">
				<div class="col-12 col-md-6 hero__text-container">
					...
					<p class="mb-4 mb-md-3">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea modi repellendus aperiam facilis commodi nisi maxime, consequuntur voluptas, atque pariatur, in voluptatem perspiciatis sunt quibusdam minus harum. Dolores, quis facilis.
					</p>
					<div class="button hero__cta">
						Ver portafolio
					</div>
				</div>
				<div class="col-12 col-md-6 hero__pic-container">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-md-9 about__text-container">
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, sint? Soluta sunt ut maiores quo necessitatibus ducimus nam fugit est? Architecto, repellat voluptatum. Iusto pariatur sint aliquam aspernatur non unde?
					</p>
					<p>
						Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla quos ea rerum necessitatibus natus dolorem incidunt modi, quas atque similique maiores, quasi libero et vitae optio ipsam velit culpa a.
					</p>
				</div>
			</div>
		</div>
				...
				<div class="col">
					...
					<div class="row">
						<div class="col-12 col-md-4">
							...
							<h3 style="text-align: center; font-size: 1.2rem;">Temas personalizados</h3>
						</div>
						<div class="col-12 col-md-4 mt-5 mt-md-0">
							...
							<h3 style="text-align: center; font-size: 1.2rem;">Plugins a medida</h3>
						</div>
						<div class="col-12 col-md-4 mt-5 mt-md-0">
							<svg class="services__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<h3 style="text-align: center; font-size: 1.2rem;">Bloques Gutenberg</h3>
						</div>
					</div>
				</div>
			</div>
