				...
				<div class="col">
					...
					<div class="row">
						<div id="theme-icon-container" class="col-12 col-md-4">
							<svg id="theme-icon" class="services__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div id="plugin-icon-container" class="col-12 col-md-4 mt-5 mt-md-0">
							<svg id="plugin-icon" class="services__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div id="block-icon-container" class="col-12 col-md-4 mt-5 mt-md-0">
							<svg id="block-icon" class="services__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
